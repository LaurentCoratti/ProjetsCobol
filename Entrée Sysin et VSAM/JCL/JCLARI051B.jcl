//ARI0111E  JOB (ACCT#),'ARIO51B',CLASS=A,MSGCLASS=H,
...
//* *                                                            *
//* *   EXECUTION DU PROGRAMME ARIO51B CORRESPONDANT AU TP N°5   *
//* *                                                            *
//* **************************************************************
//*
//* **************************************************************
...
//SYSPRINT DD  SYSOUT=*
//SYSIN    DD  *
   DELETE (ARI01.ARI0111.KCPTE5) CLUSTER
   IF MAXCC = 8 THEN SET MAXCC = 0
   DEFINE CLUSTER (NAME(ARI01.ARI0111.KCPTE5)         -
                   VOLUME(WRK001)                            -
                   TRACKS(3 1)                               -
                   FREESPACE(20 20)                          -
                   KEYS(10 0)                                -
                   RECORDSIZE(80 80)                         -
                   INDEXED)                                  -
          DATA    (NAME(ARI01.ARI0111.KCPTE5.D)) -
          INDEX   (NAME(ARI01.ARI0111.KCPTE5.I))
   REPRO INDATASET(ARI01.ARI0111.TP5.FCPTE)          -
         OUTDATASET(ARI01.ARI0111.KCPTE5)
   DEFINE AIX     (NAME(ARI01.ARI0111.KCPTE5.AIX) -
                   VOLUME(WRK001)                            -
                   RELATE(ARI01.ARI0111.KCPTE5) -
                   TRACKS(3 1)                               -
                   NONUNIQUEKEY                              -
                   UPGRADE                                   -
                   FREESPACE(20 20)                          -
                   KEYS(20 10)                               -
                   RECORDSIZE(65 65))                        -
          DATA    (NAME(ARI01.ARI0111.KCPTE5.AIX.D)) -
          INDEX   (NAME(ARI01.ARI0111.KCPTE5.AIX.I))
      DEFINE PATH (NAME(ARI01.ARI0111.KCPTE5.PATH) -
                   PATHENTRY(ARI01.ARI0111.KCPTE5.AIX)-
                   UPDATE)
         BLDINDEX  INDATASET(ARI01.ARI0111.KCPTE5) -
                   OUTDATASET (ARI01.ARI0111.KCPTE5.AIX)-
                   INTERNALSORT
   PRINT INDATASET(ARI01.ARI0111.KCPTE5)
/*
//*
//* **************************************************************
//* * ETAPE 7                                                    *
...
//* **************************************************************
//INP001   DD  DISP=SHR,DSN=ARI01.ARI0111.KCPTE5
//INP0011  DD  DISP=SHR,DSN=ARI01.ARI0111.KCPTE5.PATH
//* **************************************************************
